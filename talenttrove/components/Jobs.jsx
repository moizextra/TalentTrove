...
const Jobs = () => {
  return (
    ...
    <section className="mt-10 ml-8 job bg-white-500 ">
<div className="flex mb-9">
    ...
    <div>
      <h2 className="">React Enginner</h2>
      <span>AMS Extra</span>
...
<div className="skills mt-9">
<span className="border-white p-3 m-3  bg-slate-100 rounded-xl">React</span>
<span className="border-white p-3 m-3  bg-slate-100 rounded-xl">Next</span>
<span className="border-white p-3 m-3  bg-slate-100 rounded-xl">Node</span>
<span className="border-white p-3 m-3  bg-slate-100 rounded-xl">js</span>
<span className="border-white p-3 m-3  bg-slate-100 rounded-xl">Django</span>
</div>
<div className="flex justify-between mt-4 items-center">
  <span>Full time</span>
  <div className="flex">
    <button>View Details</button>
    <button className="m-6 rounded-xl bg-green-500 text-white p-2 w-40">Apply Now</button>
  </div>
</div>
